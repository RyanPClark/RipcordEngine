...
public class ShadowMapMasterRenderer {
	 ...
	 */
	public ShadowMapMasterRenderer(Entity camera) {
	 ...
	 */
	public void render(Map<TexturedModel, List<Entity>> entities, Entity sun) {
		shadowBox.update();
		Position pos = (Position)sun.getComponentByType(CompType.POSITION);
		Vector3f sunPosition = pos.getPosition();
